...
import { CellItem, CellGroup, CellPanel, CellItemInput } from './components/cell';
...
import { CellItemFaq } from './components/faq';
import { StickyNav, StickyPanel } from './components/stickynav';
...
const install = function(Vue) {
    ...
    Vue.component(StickyPanel.name, StickyPanel);
    Vue.component(CellItemFaq.name, CellItemFaq);
