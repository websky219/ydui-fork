    ...
    <div class="yd-input">
        <template v-if="regex == 'mobile'">
            <input ref="input" type="tel" pattern="[0-9]*"
                   v-model="currentValue" :id="id" :data-rule="dataRule" :name="name" @focus="focusHandler" @blur="blurHandler" maxlength="11" :placeholder="placeholder" :autocomplete="autocomplete" :readonly="readonly" :disabled="disabled"
            >
        </template>
        <template v-else>
            <template v-if="type == 'password'">
                <input ref="input" v-if="!showPwd" type="password"
                       v-model="currentValue" :id="id" :data-rule="dataRule" :name="name" @focus="focusHandler" @blur="blurHandler" :maxlength="max" :placeholder="placeholder" :autocomplete="autocomplete" :readonly="readonly" :disabled="disabled"
                >
        ...
        <span class="yd-input-success" v-if="suffixText" v-text="suffixText"></span>
    </div>
</template>
